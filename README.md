...
- Read DDS texture files with various compression/uncompressed formats
- Support for BC1/DXT1, BC2/DXT3, BC3/DXT5, BC4, BC5, BC6H, and BC7 compression
...
- Export to any format supported by imageio (PNG, JPEG, TIFF, HDR, etc.)
...
# Returns uint8 RGBA array if SDR, float32 RGB array if HDR
# Choose imageio output format appropriately
...
- **BC6H**: HDR RGB compression (half-float)
